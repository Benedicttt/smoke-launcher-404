class RegApp
  def post_sign_up(device, locale, password, i_agree, email, cookies, device_id, app_version)
  ...
  def post_sign_up_v2(device, locale, password, i_agree, email, device_id, app_version)
