...
RSpec.describe "Profile success" do
  before(:context) do
    @profile_edit = ProfileEditApp.new.edit_welcome(
      "ios",
      "ru",
      "RU",
      23431,
      ...
      "Selenium",
      true,
      "up_sign.#{SecureRandom.hex(8)}@yopmail.com",
      "+79812323232",
      false,
      false,
      false,
  ...
  after(:context) do
    @profile_rechange = ProfileEditApp.new.edit_welcome(
      "ios",
      "ru",
      "RU", 23431,
      "Change First",
      ...
      "Selenium",
      true,
      "sign_up.#{SecureRandom.hex(8)}@yopmail.com",
      "+79810000000",
      true,
      true,
      true,
