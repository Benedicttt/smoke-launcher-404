class Deals
  def list_status_open(device, locale, password, i_agree, email, demo, amount, asset, option_type, trend, source, create_at, expire_at)
  ...
  def list_status_close(device, locale, password, i_agree, email, demo, amount, asset, option_type, trend, source, create_at, expire_at)
